...
export function evaluatorPrompt({
  ...
  return [
    ...
    `Use ONLY the interview transcript, and the job description provided below. Do NOT invent details or assume unstated facts.`,
    ...
    `- Use only evidence found in the transcript; you may reference JD to calibrate expectations, not to invent facts.`,
